...
// (DO NOT EDIT: machine generated header) 'System.Net.HttpClient.pas' rev: 33.00 (Windows)
...
/*Helper*/typedef void *THTTPClientHelper;
...
enum class DECLSPEC_DENUM THTTPSecureProtocol : unsigned char { SSL2, SSL3, TLS1, TLS11, TLS12 };
...
typedef void __fastcall (*TReceiveDataCallback)(System::TObject* const Sender, __int64 AContentLength, __int64 AReadCount, bool &Abort);
...
#ifndef _WIN64
typedef System::DynamicArray<TCookie> TCookiesArray;
#else /* _WIN64 */
...
#ifndef _WIN64
	System::DynamicArray<TCookie> __fastcall GetCookies();
#else /* _WIN64 */
...
#ifndef _WIN64
	__property System::DynamicArray<TCookie> Cookies = {read=GetCookies};
#else /* _WIN64 */
...
__interface IHTTPRequest  : public System::Net::Urlclient::IURLRequest 
{
...
#ifndef _WIN64
	virtual System::DynamicArray<System::Net::Urlclient::TNameValuePair> __fastcall GetHeaders() = 0 ;
	__property System::DynamicArray<System::Net::Urlclient::TNameValuePair> Headers = {read=GetHeaders};
#else /* _WIN64 */
	...
	virtual TReceiveDataCallback __fastcall GetReceiveDataCallback() = 0 ;
	virtual void __fastcall SetReceiveDataCallback(const TReceiveDataCallback Value) = 0 ;
	...
	__property TReceiveDataCallback ReceiveDataCallback = {read=GetReceiveDataCallback, write=SetReceiveDataCallback};
...
private:
	TReceiveDataCallback FReceiveDataCallback;
	...
	TReceiveDataCallback __fastcall GetReceiveDataCallback();
	void __fastcall SetReceiveDataCallback(const TReceiveDataCallback Value);
...
protected:
#ifndef _WIN64
	System::DynamicArray<System::Net::Urlclient::TNameValuePair> FHeaders;
#else /* _WIN64 */
...
#ifndef _WIN64
		System::DynamicArray<System::Net::Urlclient::TCredentialsStorage::TCredential> ProxyCredentials;
#else /* _WIN64 */
...
#ifndef _WIN64
		System::DynamicArray<System::Net::Urlclient::TCredentialsStorage::TCredential> ServerCredentials;
#else /* _WIN64 */
...
public:
...
#ifndef _WIN64
	void __fastcall CreateFormFromStings(System::Classes::TStrings* const ASource, System::Sysutils::TEncoding* const AEncoding, const System::DynamicArray<System::Net::Urlclient::TNameValuePair> AHeaders, System::Classes::TStream* &ASourceStream, System::DynamicArray<System::Net::Urlclient::TNameValuePair> &ASourceHeaders);
	...
	System::Types::_di_IAsyncResult __fastcall BeginGet(const System::UnicodeString AURL, System::Classes::TStream* const AResponseContent = (System::Classes::TStream*)(0x0), const System::DynamicArray<System::Net::Urlclient::TNameValuePair> AHeaders = System::DynamicArray<System::Net::Urlclient::TNameValuePair>())/* overload */;
...
#else /* _WIN64 */
	void __fastcall CreateFormFromStings(System::Classes::TStrings* const ASource, System::Sysutils::TEncoding* const AEncoding, const System::TArray__1<System::Net::Urlclient::TNameValuePair> AHeaders, System::Classes::TStream* &ASourceStream, System::TArray__1<System::Net::Urlclient::TNameValuePair> &ASourceHeaders);
	...
	_di_IHTTPResponse __fastcall Trace(const System::UnicodeString AURL, System::Classes::TStream* const AResponseContent = (System::Classes::TStream*)(0x0), const System::DynamicArray<System::Net::Urlclient::TNameValuePair> AHeaders = System::DynamicArray<System::Net::Urlclient::TNameValuePair>());
	System::Types::_di_IAsyncResult __fastcall BeginTrace(const System::UnicodeString AURL, System::Classes::TStream* const AResponseContent = (System::Classes::TStream*)(0x0), const System::DynamicArray<System::Net::Urlclient::TNameValuePair> AHeaders = System::DynamicArray<System::Net::Urlclient::TNameValuePair>())/* overload */;
	...
	_di_IHTTPResponse __fastcall Head(const System::UnicodeString AURL, const System::DynamicArray<System::Net::Urlclient::TNameValuePair> AHeaders = System::DynamicArray<System::Net::Urlclient::TNameValuePair>());
	System::Types::_di_IAsyncResult __fastcall BeginHead(const System::UnicodeString AURL, const System::DynamicArray<System::Net::Urlclient::TNameValuePair> AHeaders = System::DynamicArray<System::Net::Urlclient::TNameValuePair>())/* overload */;
	System::Types::_di_IAsyncResult __fastcall BeginHead(const System::Classes::_di_TAsyncCallback AsyncCallback, const System::UnicodeString AURL, const System::DynamicArray<System::Net::Urlclient::TNameValuePair> AHeaders = System::DynamicArray<System::Net::Urlclient::TNameValuePair>())/* overload */;
	System::Types::_di_IAsyncResult __fastcall BeginHead(const System::Classes::TAsyncProcedureEvent AsyncCallbackEvent, const System::UnicodeString AURL, const System::DynamicArray<System::Net::Urlclient::TNameValuePair> AHeaders = System::DynamicArray<System::Net::Urlclient::TNameValuePair>())/* overload */;
	...
	__property bool HandleRedirects = {read=FHandleRedirects, write=FHandleRedirects, nodefault};
	...
	__property TReceiveDataCallback ReceiveDataCallBack = {read=FReceiveDataCallback, write=FReceiveDataCallback};
	...
	__property bool AllowCookies = {read=FAllowCookies, write=FAllowCookies, nodefault};
...
//-- var, const, procedure ---------------------------------------------------
#define sHTTPMethodConnect L"CONNECT"
#define sHTTPMethodDelete L"DELETE"
#define sHTTPMethodGet L"GET"
#define sHTTPMethodHead L"HEAD"
#define sHTTPMethodOptions L"OPTIONS"
#define sHTTPMethodPost L"POST"
#define sHTTPMethodPut L"PUT"
#define sHTTPMethodTrace L"TRACE"
#define sHTTPMethodMerge L"MERGE"
#define sHTTPMethodPatch L"PATCH"
...
static const System::Int8 CHTTPDefMaxRedirects = System::Int8(0x5);
}	/* namespace Httpclient */
}	/* namespace Net */
}	/* namespace System */

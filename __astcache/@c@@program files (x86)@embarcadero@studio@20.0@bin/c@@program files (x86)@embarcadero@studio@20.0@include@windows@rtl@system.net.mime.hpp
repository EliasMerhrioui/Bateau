...
// (DO NOT EDIT: machine generated header) 'System.Net.Mime.pas' rev: 33.00 (Windows)
...
#ifndef _WIN64
	void __fastcall AddBytes(const System::UnicodeString AField, const System::DynamicArray<System::Byte> ABytes, const System::UnicodeString AFileName = System::UnicodeString(), const System::UnicodeString AContentType = System::UnicodeString());
#else /* _WIN64 */
...
typedef TAcceptValueListBase__1<TAcceptValueItem*>* TAcceptValueList;
